...
namespace system_obslugi_serwisu.Infrastructure.Migrations
{
    ...
    [Migration("20251201141756_AssigningWorkersToRepairs")]
    partial class AssigningWorkersToRepairs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("system_obslugi_serwisu.Domain.Conversations.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("system_obslugi_serwisu.Domain.Workers.Worker", b =>
                {
                    ...
                    b.Property<Guid?>("AssignedRepairId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("system_obslugi_serwisu.Domain.Conversations.Message", b =>
                {
                    b.HasOne("system_obslugi_serwisu.Domain.Conversations.Conversation", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("system_obslugi_serwisu.Domain.RepairShops.RepairShopImage", b =>
                {
                    b.HasOne("system_obslugi_serwisu.Domain.Shared.Image", "Image")
                        .WithOne()
                        .HasForeignKey("system_obslugi_serwisu.Domain.RepairShops.RepairShopImage", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("system_obslugi_serwisu.Domain.Repairs.Repair", b =>
                {
                    ...
                    b.OwnsOne("system_obslugi_serwisu.Domain.Repairs.TicketNumber", "TicketNumber", b1 =>
                        {
                            b1.Property<Guid>("RepairId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("system_obslugi_serwisu.Domain.Repairs.RepairImage", b =>
                {
                    b.HasOne("system_obslugi_serwisu.Domain.Shared.Image", "Image")
                        .WithOne()
                        .HasForeignKey("system_obslugi_serwisu.Domain.Repairs.RepairImage", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("system_obslugi_serwisu.Domain.Repairs.Repair", null)
                        .WithMany("Images")
                        .HasForeignKey("RepairId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
