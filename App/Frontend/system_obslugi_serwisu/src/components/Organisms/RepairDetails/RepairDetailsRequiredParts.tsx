...
type RepairDetailsRequiredPartsProps = {
    repairId: string;

}

/*
export function RepairDetailsRequiredParts({repairId}: RepairDetailsRequiredPartsProps) {
    ...
    const {
        data,
        loading
    } = useQuery<GetNeeded, GetPartReservationsQueryVariables>(GET_PART_RESERVATIONS, {
        variables: {
            partId,
