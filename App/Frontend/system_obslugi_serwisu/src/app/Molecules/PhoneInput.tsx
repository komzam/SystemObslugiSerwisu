...
export function PhoneInput({countryCode, onCountryChange, phone, onPhoneChange, wrapperClassName="", className="", id, label}: PhoneInputProps) {
    ...
    return(
        <div className={`bg-inherit flex flex-row items-end gap-3 ${wrapperClassName}`}>
            ...
            <LabeledTextInput wrapperClassName="flex-1" className={`w-full ${className}`} id={id} label={label}
